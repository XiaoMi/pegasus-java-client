...
PEGASUS_PKG="pegasus-server-1.13.SNAPSHOT-695b366-glibc2.17-release"
PEGASUS_PKG_URL="https://github.com/XiaoMi/pegasus-common/releases/download/deps/pegasus-server-1.13.SNAPSHOT-695b366-glibc2.17-release.tar.gz"
