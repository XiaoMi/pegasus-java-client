...
public class check_and_set_request implements com.xiaomi.infra.pegasus.thrift.TBase<check_and_set_request, check_and_set_request._Fields>, java.io.Serializable, Cloneable, Comparable<check_and_set_request> {
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TStruct STRUCT_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TStruct("check_and_set_request");
  ...
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TField SET_DIFF_SORT_KEY_FIELD_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TField("set_diff_sort_key", com.xiaomi.infra.pegasus.thrift.protocol.TType.BOOL, (short)5);
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TField SET_SORT_KEY_FIELD_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TField("set_sort_key", com.xiaomi.infra.pegasus.thrift.protocol.TType.STRUCT, (short)6);
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TField SET_VALUE_FIELD_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TField("set_value", com.xiaomi.infra.pegasus.thrift.protocol.TType.STRUCT, (short)7);
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TField SET_EXPIRE_TS_SECONDS_FIELD_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TField("set_expire_ts_seconds", com.xiaomi.infra.pegasus.thrift.protocol.TType.I32, (short)8);
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TField RETURN_CHECK_VALUE_FIELD_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TField("return_check_value", com.xiaomi.infra.pegasus.thrift.protocol.TType.BOOL, (short)9);

  private static final com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new check_and_set_requestStandardSchemeFactory();
  private static final com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new check_and_set_requestTupleSchemeFactory();
  ...
  static {
    ...
    tmpMap.put(_Fields.CHECK_OPERAND, new com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData("check_operand", com.xiaomi.infra.pegasus.thrift.TFieldRequirementType.DEFAULT, 
        new com.xiaomi.infra.pegasus.thrift.meta_data.StructMetaData(com.xiaomi.infra.pegasus.thrift.protocol.TType.STRUCT, com.xiaomi.infra.pegasus.base.blob.class)));
    tmpMap.put(_Fields.SET_DIFF_SORT_KEY, new com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData("set_diff_sort_key", com.xiaomi.infra.pegasus.thrift.TFieldRequirementType.DEFAULT, 
        new com.xiaomi.infra.pegasus.thrift.meta_data.FieldValueMetaData(com.xiaomi.infra.pegasus.thrift.protocol.TType.BOOL)));
    tmpMap.put(_Fields.SET_SORT_KEY, new com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData("set_sort_key", com.xiaomi.infra.pegasus.thrift.TFieldRequirementType.DEFAULT, 
        new com.xiaomi.infra.pegasus.thrift.meta_data.StructMetaData(com.xiaomi.infra.pegasus.thrift.protocol.TType.STRUCT, com.xiaomi.infra.pegasus.base.blob.class)));
    tmpMap.put(_Fields.SET_VALUE, new com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData("set_value", com.xiaomi.infra.pegasus.thrift.TFieldRequirementType.DEFAULT, 
        new com.xiaomi.infra.pegasus.thrift.meta_data.StructMetaData(com.xiaomi.infra.pegasus.thrift.protocol.TType.STRUCT, com.xiaomi.infra.pegasus.base.blob.class)));
    ...
    com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData.addStructMetaDataMap(check_and_set_request.class, metaDataMap);
  }
  ...
  public void unsetSet_diff_sort_key() {
    __isset_bitfield = com.xiaomi.infra.pegasus.thrift.EncodingUtils.clearBit(__isset_bitfield, __SET_DIFF_SORT_KEY_ISSET_ID);
  }
  ...
  public boolean isSetSet_diff_sort_key() {
    return com.xiaomi.infra.pegasus.thrift.EncodingUtils.testBit(__isset_bitfield, __SET_DIFF_SORT_KEY_ISSET_ID);
  }

  public void setSet_diff_sort_keyIsSet(boolean value) {
    __isset_bitfield = com.xiaomi.infra.pegasus.thrift.EncodingUtils.setBit(__isset_bitfield, __SET_DIFF_SORT_KEY_ISSET_ID, value);
  }
  ...
  public int compareTo(check_and_set_request other) {
    ...
    if (isSetSet_diff_sort_key()) {
      lastComparison = com.xiaomi.infra.pegasus.thrift.TBaseHelper.compareTo(this.set_diff_sort_key, other.set_diff_sort_key);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetSet_sort_key()) {
      lastComparison = com.xiaomi.infra.pegasus.thrift.TBaseHelper.compareTo(this.set_sort_key, other.set_sort_key);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetSet_value()) {
      lastComparison = com.xiaomi.infra.pegasus.thrift.TBaseHelper.compareTo(this.set_value, other.set_value);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class check_and_set_requestStandardSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public check_and_set_requestStandardScheme getScheme() {
      return new check_and_set_requestStandardScheme();
    }
  }

  private static class check_and_set_requestStandardScheme extends com.xiaomi.infra.pegasus.thrift.scheme.StandardScheme<check_and_set_request> {

    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol iprot, check_and_set_request struct) throws com.xiaomi.infra.pegasus.thrift.TException {
    ...
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol oprot, check_and_set_request struct) throws com.xiaomi.infra.pegasus.thrift.TException {
      struct.validate();
  ...
  private static class check_and_set_requestTupleSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public check_and_set_requestTupleScheme getScheme() {
      return new check_and_set_requestTupleScheme();
    }
  }

  private static class check_and_set_requestTupleScheme extends com.xiaomi.infra.pegasus.thrift.scheme.TupleScheme<check_and_set_request> {

    @Override
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, check_and_set_request struct) throws com.xiaomi.infra.pegasus.thrift.TException {
    ...
    @Override
    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, check_and_set_request struct) throws com.xiaomi.infra.pegasus.thrift.TException {
