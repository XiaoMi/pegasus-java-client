...
public class check_and_set_response implements com.xiaomi.infra.pegasus.thrift.TBase<check_and_set_response, check_and_set_response._Fields>, java.io.Serializable, Cloneable, Comparable<check_and_set_response> {
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TStruct STRUCT_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TStruct("check_and_set_response");
  ...
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TField CHECK_VALUE_RETURNED_FIELD_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TField("check_value_returned", com.xiaomi.infra.pegasus.thrift.protocol.TType.BOOL, (short)2);
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TField CHECK_VALUE_EXIST_FIELD_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TField("check_value_exist", com.xiaomi.infra.pegasus.thrift.protocol.TType.BOOL, (short)3);
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TField CHECK_VALUE_FIELD_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TField("check_value", com.xiaomi.infra.pegasus.thrift.protocol.TType.STRUCT, (short)4);
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TField APP_ID_FIELD_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TField("app_id", com.xiaomi.infra.pegasus.thrift.protocol.TType.I32, (short)5);
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TField PARTITION_INDEX_FIELD_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TField("partition_index", com.xiaomi.infra.pegasus.thrift.protocol.TType.I32, (short)6);
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TField DECREE_FIELD_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TField("decree", com.xiaomi.infra.pegasus.thrift.protocol.TType.I64, (short)7);
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TField SERVER_FIELD_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TField("server", com.xiaomi.infra.pegasus.thrift.protocol.TType.STRING, (short)8);

  private static final com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new check_and_set_responseStandardSchemeFactory();
  private static final com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new check_and_set_responseTupleSchemeFactory();
  ...
  static {
    ...
    tmpMap.put(_Fields.CHECK_VALUE_RETURNED, new com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData("check_value_returned", com.xiaomi.infra.pegasus.thrift.TFieldRequirementType.DEFAULT, 
        new com.xiaomi.infra.pegasus.thrift.meta_data.FieldValueMetaData(com.xiaomi.infra.pegasus.thrift.protocol.TType.BOOL)));
    tmpMap.put(_Fields.CHECK_VALUE_EXIST, new com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData("check_value_exist", com.xiaomi.infra.pegasus.thrift.TFieldRequirementType.DEFAULT, 
        new com.xiaomi.infra.pegasus.thrift.meta_data.FieldValueMetaData(com.xiaomi.infra.pegasus.thrift.protocol.TType.BOOL)));
    tmpMap.put(_Fields.CHECK_VALUE, new com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData("check_value", com.xiaomi.infra.pegasus.thrift.TFieldRequirementType.DEFAULT, 
    ...
    tmpMap.put(_Fields.PARTITION_INDEX, new com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData("partition_index", com.xiaomi.infra.pegasus.thrift.TFieldRequirementType.DEFAULT, 
        new com.xiaomi.infra.pegasus.thrift.meta_data.FieldValueMetaData(com.xiaomi.infra.pegasus.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.DECREE, new com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData("decree", com.xiaomi.infra.pegasus.thrift.TFieldRequirementType.DEFAULT, 
    ...
    com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData.addStructMetaDataMap(check_and_set_response.class, metaDataMap);
  }
  ...
  public void unsetCheck_value_returned() {
    __isset_bitfield = com.xiaomi.infra.pegasus.thrift.EncodingUtils.clearBit(__isset_bitfield, __CHECK_VALUE_RETURNED_ISSET_ID);
  }
  ...
  public boolean isSetCheck_value_returned() {
    return com.xiaomi.infra.pegasus.thrift.EncodingUtils.testBit(__isset_bitfield, __CHECK_VALUE_RETURNED_ISSET_ID);
  }

  public void setCheck_value_returnedIsSet(boolean value) {
    __isset_bitfield = com.xiaomi.infra.pegasus.thrift.EncodingUtils.setBit(__isset_bitfield, __CHECK_VALUE_RETURNED_ISSET_ID, value);
  }
  ...
  public void unsetCheck_value_exist() {
    __isset_bitfield = com.xiaomi.infra.pegasus.thrift.EncodingUtils.clearBit(__isset_bitfield, __CHECK_VALUE_EXIST_ISSET_ID);
  }
  ...
  public boolean isSetCheck_value_exist() {
    return com.xiaomi.infra.pegasus.thrift.EncodingUtils.testBit(__isset_bitfield, __CHECK_VALUE_EXIST_ISSET_ID);
  }

  public void setCheck_value_existIsSet(boolean value) {
    __isset_bitfield = com.xiaomi.infra.pegasus.thrift.EncodingUtils.setBit(__isset_bitfield, __CHECK_VALUE_EXIST_ISSET_ID, value);
  }
  ...
  public void unsetDecree() {
    __isset_bitfield = com.xiaomi.infra.pegasus.thrift.EncodingUtils.clearBit(__isset_bitfield, __DECREE_ISSET_ID);
  }

  /** Returns true if field decree is set (has been assigned a value) and false otherwise */
  public boolean isSetDecree() {
    return com.xiaomi.infra.pegasus.thrift.EncodingUtils.testBit(__isset_bitfield, __DECREE_ISSET_ID);
  }

  public void setDecreeIsSet(boolean value) {
    __isset_bitfield = com.xiaomi.infra.pegasus.thrift.EncodingUtils.setBit(__isset_bitfield, __DECREE_ISSET_ID, value);
  }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + com.xiaomi.infra.pegasus.thrift.TBaseHelper.hashCode(decree);
  ...
  public int compareTo(check_and_set_response other) {
    ...
    if (isSetCheck_value_returned()) {
      lastComparison = com.xiaomi.infra.pegasus.thrift.TBaseHelper.compareTo(this.check_value_returned, other.check_value_returned);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetCheck_value_exist()) {
      lastComparison = com.xiaomi.infra.pegasus.thrift.TBaseHelper.compareTo(this.check_value_exist, other.check_value_exist);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetCheck_value()) {
      lastComparison = com.xiaomi.infra.pegasus.thrift.TBaseHelper.compareTo(this.check_value, other.check_value);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetDecree()) {
      lastComparison = com.xiaomi.infra.pegasus.thrift.TBaseHelper.compareTo(this.decree, other.decree);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class check_and_set_responseStandardSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public check_and_set_responseStandardScheme getScheme() {
      return new check_and_set_responseStandardScheme();
    }
  }

  private static class check_and_set_responseStandardScheme extends com.xiaomi.infra.pegasus.thrift.scheme.StandardScheme<check_and_set_response> {

    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol iprot, check_and_set_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
    ...
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol oprot, check_and_set_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
      struct.validate();
  ...
  private static class check_and_set_responseTupleSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public check_and_set_responseTupleScheme getScheme() {
      return new check_and_set_responseTupleScheme();
    }
  }

  private static class check_and_set_responseTupleScheme extends com.xiaomi.infra.pegasus.thrift.scheme.TupleScheme<check_and_set_response> {

    @Override
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, check_and_set_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
    ...
    @Override
    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, check_and_set_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
