...
public class count_response implements com.xiaomi.infra.pegasus.thrift.TBase<count_response, count_response._Fields>, java.io.Serializable, Cloneable, Comparable<count_response> {
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TStruct STRUCT_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TStruct("count_response");
  ...
  private static final com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new count_responseStandardSchemeFactory();
  ...
  static {
    ...
    com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData.addStructMetaDataMap(count_response.class, metaDataMap);
  }
  ...
  private static class count_responseStandardSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public count_responseStandardScheme getScheme() {
      return new count_responseStandardScheme();
    }
  }

  private static class count_responseStandardScheme extends com.xiaomi.infra.pegasus.thrift.scheme.StandardScheme<count_response> {

    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol iprot, count_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
    ...
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol oprot, count_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
      struct.validate();
  ...
  private static class count_responseTupleSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public count_responseTupleScheme getScheme() {
      return new count_responseTupleScheme();
    }
  }

  private static class count_responseTupleScheme extends com.xiaomi.infra.pegasus.thrift.scheme.TupleScheme<count_response> {

    @Override
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, count_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
    ...
    @Override
    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, count_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
