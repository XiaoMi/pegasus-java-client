...
public class incr_response implements com.xiaomi.infra.pegasus.thrift.TBase<incr_response, incr_response._Fields>, java.io.Serializable, Cloneable, Comparable<incr_response> {
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TStruct STRUCT_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TStruct("incr_response");
  ...
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TField NEW_VALUE_FIELD_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TField("new_value", com.xiaomi.infra.pegasus.thrift.protocol.TType.I64, (short)2);
  ...
  private static final com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new incr_responseStandardSchemeFactory();
  private static final com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new incr_responseTupleSchemeFactory();
  ...
  static {
    ...
    tmpMap.put(_Fields.NEW_VALUE, new com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData("new_value", com.xiaomi.infra.pegasus.thrift.TFieldRequirementType.DEFAULT, 
    ...
    com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData.addStructMetaDataMap(incr_response.class, metaDataMap);
  }
  ...
  public void unsetNew_value() {
    __isset_bitfield = com.xiaomi.infra.pegasus.thrift.EncodingUtils.clearBit(__isset_bitfield, __NEW_VALUE_ISSET_ID);
  }

  /** Returns true if field new_value is set (has been assigned a value) and false otherwise */
  public boolean isSetNew_value() {
    return com.xiaomi.infra.pegasus.thrift.EncodingUtils.testBit(__isset_bitfield, __NEW_VALUE_ISSET_ID);
  }

  public void setNew_valueIsSet(boolean value) {
    __isset_bitfield = com.xiaomi.infra.pegasus.thrift.EncodingUtils.setBit(__isset_bitfield, __NEW_VALUE_ISSET_ID, value);
  }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + com.xiaomi.infra.pegasus.thrift.TBaseHelper.hashCode(new_value);
  ...
  public int compareTo(incr_response other) {
    ...
    if (isSetNew_value()) {
      lastComparison = com.xiaomi.infra.pegasus.thrift.TBaseHelper.compareTo(this.new_value, other.new_value);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class incr_responseStandardSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public incr_responseStandardScheme getScheme() {
      return new incr_responseStandardScheme();
    }
  }

  private static class incr_responseStandardScheme extends com.xiaomi.infra.pegasus.thrift.scheme.StandardScheme<incr_response> {

    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol iprot, incr_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
    ...
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol oprot, incr_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
      struct.validate();
  ...
  private static class incr_responseTupleSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public incr_responseTupleScheme getScheme() {
      return new incr_responseTupleScheme();
    }
  }

  private static class incr_responseTupleScheme extends com.xiaomi.infra.pegasus.thrift.scheme.TupleScheme<incr_response> {

    @Override
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, incr_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
    ...
    @Override
    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, incr_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
