...
public class key_value implements com.xiaomi.infra.pegasus.thrift.TBase<key_value, key_value._Fields>, java.io.Serializable, Cloneable, Comparable<key_value> {
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TStruct STRUCT_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TStruct("key_value");
  ...
  private static final com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new key_valueStandardSchemeFactory();
  private static final com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new key_valueTupleSchemeFactory();
  ...
  static {
    ...
    com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData.addStructMetaDataMap(key_value.class, metaDataMap);
  }
  ...
  public key_value setKey(com.xiaomi.infra.pegasus.base.blob key) {
    this.key = key;
    return this;
  }
  ...
  public key_value setValue(com.xiaomi.infra.pegasus.base.blob value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof key_value)
      return this.equals((key_value)that);
    return false;
  }
  ...
  private static class key_valueStandardSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public key_valueStandardScheme getScheme() {
      return new key_valueStandardScheme();
    }
  }

  private static class key_valueStandardScheme extends com.xiaomi.infra.pegasus.thrift.scheme.StandardScheme<key_value> {

    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol iprot, key_value struct) throws com.xiaomi.infra.pegasus.thrift.TException {
    ...
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol oprot, key_value struct) throws com.xiaomi.infra.pegasus.thrift.TException {
      struct.validate();
  ...
  private static class key_valueTupleSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public key_valueTupleScheme getScheme() {
      return new key_valueTupleScheme();
    }
  }

  private static class key_valueTupleScheme extends com.xiaomi.infra.pegasus.thrift.scheme.TupleScheme<key_value> {

    @Override
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, key_value struct) throws com.xiaomi.infra.pegasus.thrift.TException {
    ...
    @Override
    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, key_value struct) throws com.xiaomi.infra.pegasus.thrift.TException {
