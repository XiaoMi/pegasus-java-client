...
public class multi_get_response implements com.xiaomi.infra.pegasus.thrift.TBase<multi_get_response, multi_get_response._Fields>, java.io.Serializable, Cloneable, Comparable<multi_get_response> {
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TStruct STRUCT_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TStruct("multi_get_response");
  ...
  private static final com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new multi_get_responseStandardSchemeFactory();
  ...
  static {
    ...
    com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData.addStructMetaDataMap(multi_get_response.class, metaDataMap);
  }
  ...
  private static class multi_get_responseStandardSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public multi_get_responseStandardScheme getScheme() {
      return new multi_get_responseStandardScheme();
    }
  }

  private static class multi_get_responseStandardScheme extends com.xiaomi.infra.pegasus.thrift.scheme.StandardScheme<multi_get_response> {

    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol iprot, multi_get_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
    ...
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol oprot, multi_get_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
      struct.validate();
  ...
  private static class multi_get_responseTupleSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public multi_get_responseTupleScheme getScheme() {
      return new multi_get_responseTupleScheme();
    }
  }

  private static class multi_get_responseTupleScheme extends com.xiaomi.infra.pegasus.thrift.scheme.TupleScheme<multi_get_response> {

    @Override
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, multi_get_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
    ...
    @Override
    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, multi_get_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
