...
public class multi_put_request implements com.xiaomi.infra.pegasus.thrift.TBase<multi_put_request, multi_put_request._Fields>, java.io.Serializable, Cloneable, Comparable<multi_put_request> {
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TStruct STRUCT_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TStruct("multi_put_request");
  ...
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TField KVS_FIELD_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TField("kvs", com.xiaomi.infra.pegasus.thrift.protocol.TType.LIST, (short)2);
  ...
  private static final com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new multi_put_requestStandardSchemeFactory();
  private static final com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new multi_put_requestTupleSchemeFactory();
  ...
  static {
    ...
    tmpMap.put(_Fields.KVS, new com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData("kvs", com.xiaomi.infra.pegasus.thrift.TFieldRequirementType.DEFAULT, 
        new com.xiaomi.infra.pegasus.thrift.meta_data.ListMetaData(com.xiaomi.infra.pegasus.thrift.protocol.TType.LIST, 
            new com.xiaomi.infra.pegasus.thrift.meta_data.StructMetaData(com.xiaomi.infra.pegasus.thrift.protocol.TType.STRUCT, key_value.class))));
    ...
    com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData.addStructMetaDataMap(multi_put_request.class, metaDataMap);
  }
  ...
  public int compareTo(multi_put_request other) {
    ...
    if (isSetKvs()) {
      lastComparison = com.xiaomi.infra.pegasus.thrift.TBaseHelper.compareTo(this.kvs, other.kvs);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class multi_put_requestStandardSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public multi_put_requestStandardScheme getScheme() {
      return new multi_put_requestStandardScheme();
    }
  }

  private static class multi_put_requestStandardScheme extends com.xiaomi.infra.pegasus.thrift.scheme.StandardScheme<multi_put_request> {

    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol iprot, multi_put_request struct) throws com.xiaomi.infra.pegasus.thrift.TException {
    ...
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol oprot, multi_put_request struct) throws com.xiaomi.infra.pegasus.thrift.TException {
      struct.validate();
      ...
      if (struct.kvs != null) {
        ...
        {
          oprot.writeListBegin(new com.xiaomi.infra.pegasus.thrift.protocol.TList(com.xiaomi.infra.pegasus.thrift.protocol.TType.STRUCT, struct.kvs.size()));
  ...
  private static class multi_put_requestTupleSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public multi_put_requestTupleScheme getScheme() {
      return new multi_put_requestTupleScheme();
    }
  }

  private static class multi_put_requestTupleScheme extends com.xiaomi.infra.pegasus.thrift.scheme.TupleScheme<multi_put_request> {

    @Override
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, multi_put_request struct) throws com.xiaomi.infra.pegasus.thrift.TException {
    ...
    @Override
    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, multi_put_request struct) throws com.xiaomi.infra.pegasus.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          com.xiaomi.infra.pegasus.thrift.protocol.TList _list5 = new com.xiaomi.infra.pegasus.thrift.protocol.TList(com.xiaomi.infra.pegasus.thrift.protocol.TType.STRUCT, iprot.readI32());
