...
public class multi_remove_response implements com.xiaomi.infra.pegasus.thrift.TBase<multi_remove_response, multi_remove_response._Fields>, java.io.Serializable, Cloneable, Comparable<multi_remove_response> {
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TStruct STRUCT_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TStruct("multi_remove_response");
  ...
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TField COUNT_FIELD_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TField("count", com.xiaomi.infra.pegasus.thrift.protocol.TType.I64, (short)2);
  ...
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TField DECREE_FIELD_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TField("decree", com.xiaomi.infra.pegasus.thrift.protocol.TType.I64, (short)5);
  ...
  private static final com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new multi_remove_responseStandardSchemeFactory();
  private static final com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new multi_remove_responseTupleSchemeFactory();
  ...
  static {
    ...
    tmpMap.put(_Fields.COUNT, new com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData("count", com.xiaomi.infra.pegasus.thrift.TFieldRequirementType.DEFAULT, 
    ...
    com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData.addStructMetaDataMap(multi_remove_response.class, metaDataMap);
  }
   ...
   */
  public multi_remove_response(multi_remove_response other) {
  ...
  public multi_remove_response deepCopy() {
    return new multi_remove_response(this);
  }
  ...
  public multi_remove_response setError(int error) {
    this.error = error;
    setErrorIsSet(true);
    return this;
  }
  ...
  public multi_remove_response setCount(long count) {
    this.count = count;
    setCountIsSet(true);
    return this;
  }
  ...
  public void unsetCount() {
    __isset_bitfield = com.xiaomi.infra.pegasus.thrift.EncodingUtils.clearBit(__isset_bitfield, __COUNT_ISSET_ID);
  }

  /** Returns true if field count is set (has been assigned a value) and false otherwise */
  public boolean isSetCount() {
    return com.xiaomi.infra.pegasus.thrift.EncodingUtils.testBit(__isset_bitfield, __COUNT_ISSET_ID);
  }

  public void setCountIsSet(boolean value) {
    __isset_bitfield = com.xiaomi.infra.pegasus.thrift.EncodingUtils.setBit(__isset_bitfield, __COUNT_ISSET_ID, value);
  }
  ...
  public multi_remove_response setApp_id(int app_id) {
    this.app_id = app_id;
    setApp_idIsSet(true);
    return this;
  }
  ...
  public multi_remove_response setPartition_index(int partition_index) {
    this.partition_index = partition_index;
    setPartition_indexIsSet(true);
    return this;
  }
  ...
  public multi_remove_response setDecree(long decree) {
    this.decree = decree;
    setDecreeIsSet(true);
    return this;
  }
  ...
  public multi_remove_response setServer(java.lang.String server) {
    this.server = server;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof multi_remove_response)
      return this.equals((multi_remove_response)that);
    return false;
  }

  public boolean equals(multi_remove_response that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + com.xiaomi.infra.pegasus.thrift.TBaseHelper.hashCode(count);
  ...
  @Override
  public int compareTo(multi_remove_response other) {
    ...
    if (isSetCount()) {
      lastComparison = com.xiaomi.infra.pegasus.thrift.TBaseHelper.compareTo(this.count, other.count);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("multi_remove_response(");
    boolean first = true;
  ...
  private static class multi_remove_responseStandardSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public multi_remove_responseStandardScheme getScheme() {
      return new multi_remove_responseStandardScheme();
    }
  }

  private static class multi_remove_responseStandardScheme extends com.xiaomi.infra.pegasus.thrift.scheme.StandardScheme<multi_remove_response> {

    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol iprot, multi_remove_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
    ...
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol oprot, multi_remove_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
      struct.validate();
  ...
  private static class multi_remove_responseTupleSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public multi_remove_responseTupleScheme getScheme() {
      return new multi_remove_responseTupleScheme();
    }
  }

  private static class multi_remove_responseTupleScheme extends com.xiaomi.infra.pegasus.thrift.scheme.TupleScheme<multi_remove_response> {

    @Override
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, multi_remove_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
    ...
    @Override
    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, multi_remove_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
