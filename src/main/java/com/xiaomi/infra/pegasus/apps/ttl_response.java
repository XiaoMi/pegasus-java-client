...
public class ttl_response implements com.xiaomi.infra.pegasus.thrift.TBase<ttl_response, ttl_response._Fields>, java.io.Serializable, Cloneable, Comparable<ttl_response> {
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TStruct STRUCT_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TStruct("ttl_response");
  ...
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TField TTL_SECONDS_FIELD_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TField("ttl_seconds", com.xiaomi.infra.pegasus.thrift.protocol.TType.I32, (short)2);
  ...
  private static final com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new ttl_responseStandardSchemeFactory();
  private static final com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new ttl_responseTupleSchemeFactory();
  ...
  static {
    ...
    tmpMap.put(_Fields.TTL_SECONDS, new com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData("ttl_seconds", com.xiaomi.infra.pegasus.thrift.TFieldRequirementType.DEFAULT, 
        new com.xiaomi.infra.pegasus.thrift.meta_data.FieldValueMetaData(com.xiaomi.infra.pegasus.thrift.protocol.TType.I32)));
    ...
    com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ttl_response.class, metaDataMap);
  }
  ...
  public void unsetTtl_seconds() {
    __isset_bitfield = com.xiaomi.infra.pegasus.thrift.EncodingUtils.clearBit(__isset_bitfield, __TTL_SECONDS_ISSET_ID);
  }

  /** Returns true if field ttl_seconds is set (has been assigned a value) and false otherwise */
  public boolean isSetTtl_seconds() {
    return com.xiaomi.infra.pegasus.thrift.EncodingUtils.testBit(__isset_bitfield, __TTL_SECONDS_ISSET_ID);
  }

  public void setTtl_secondsIsSet(boolean value) {
    __isset_bitfield = com.xiaomi.infra.pegasus.thrift.EncodingUtils.setBit(__isset_bitfield, __TTL_SECONDS_ISSET_ID, value);
  }
  ...
  public ttl_response setServer(java.lang.String server) {
    this.server = server;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case TTL_SECONDS:
      if (value == null) {
        ...
        setTtl_seconds((java.lang.Integer)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ttl_seconds;
  ...
  public int compareTo(ttl_response other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetTtl_seconds()).compareTo(other.isSetTtl_seconds());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTtl_seconds()) {
      lastComparison = com.xiaomi.infra.pegasus.thrift.TBaseHelper.compareTo(this.ttl_seconds, other.ttl_seconds);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("ttl_response(");
    boolean first = true;
  ...
  private static class ttl_responseStandardSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public ttl_responseStandardScheme getScheme() {
      return new ttl_responseStandardScheme();
    }
  }

  private static class ttl_responseStandardScheme extends com.xiaomi.infra.pegasus.thrift.scheme.StandardScheme<ttl_response> {

    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol iprot, ttl_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
    ...
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol oprot, ttl_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
      struct.validate();
  ...
  private static class ttl_responseTupleSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public ttl_responseTupleScheme getScheme() {
      return new ttl_responseTupleScheme();
    }
  }

  private static class ttl_responseTupleScheme extends com.xiaomi.infra.pegasus.thrift.scheme.TupleScheme<ttl_response> {

    @Override
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, ttl_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
    ...
    @Override
    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, ttl_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
