...
public class update_response implements com.xiaomi.infra.pegasus.thrift.TBase<update_response, update_response._Fields>, java.io.Serializable, Cloneable, Comparable<update_response> {
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TStruct STRUCT_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TStruct("update_response");
  ...
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TField PARTITION_INDEX_FIELD_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TField("partition_index", com.xiaomi.infra.pegasus.thrift.protocol.TType.I32, (short)3);
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TField DECREE_FIELD_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TField("decree", com.xiaomi.infra.pegasus.thrift.protocol.TType.I64, (short)4);
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TField SERVER_FIELD_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TField("server", com.xiaomi.infra.pegasus.thrift.protocol.TType.STRING, (short)5);

  private static final com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new update_responseStandardSchemeFactory();
  private static final com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new update_responseTupleSchemeFactory();
  ...
  public enum _Fields implements com.xiaomi.infra.pegasus.thrift.TFieldIdEnum {
    ...
    PARTITION_INDEX((short)3, "partition_index"),
    DECREE((short)4, "decree"),
  ...
  private static final int __DECREE_ISSET_ID = 3;
  ...
  static {
    ...
    com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData.addStructMetaDataMap(update_response.class, metaDataMap);
  }
   ...
   */
  public update_response(update_response other) {
  ...
  public update_response deepCopy() {
    return new update_response(this);
  }
  ...
  public update_response setError(int error) {
    this.error = error;
    setErrorIsSet(true);
    return this;
  }
  ...
  public update_response setApp_id(int app_id) {
    this.app_id = app_id;
    setApp_idIsSet(true);
    return this;
  }
  ...
  public update_response setPartition_index(int partition_index) {
    this.partition_index = partition_index;
    setPartition_indexIsSet(true);
    return this;
  }
  ...
  public update_response setDecree(long decree) {
    this.decree = decree;
    setDecreeIsSet(true);
    return this;
  }
  ...
  public update_response setServer(java.lang.String server) {
    this.server = server;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof update_response)
      return this.equals((update_response)that);
    return false;
  }

  public boolean equals(update_response that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(update_response other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("update_response(");
    boolean first = true;
  ...
  private static class update_responseStandardSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public update_responseStandardScheme getScheme() {
      return new update_responseStandardScheme();
    }
  }

  private static class update_responseStandardScheme extends com.xiaomi.infra.pegasus.thrift.scheme.StandardScheme<update_response> {

    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol iprot, update_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
    ...
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol oprot, update_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
      struct.validate();
  ...
  private static class update_responseTupleSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public update_responseTupleScheme getScheme() {
      return new update_responseTupleScheme();
    }
  }

  private static class update_responseTupleScheme extends com.xiaomi.infra.pegasus.thrift.scheme.TupleScheme<update_response> {

    @Override
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, update_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
    ...
    @Override
    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, update_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
