...
public class PegasusTable implements PegasusTableInterface {
    ...
    public Future<Long> asyncSortKeyCount(byte[] hashKey, int timeout) {
        ...
        rrdb_sortkey_count_operator op = new rrdb_sortkey_count_operator(pid, table.getTableName(), hashKeyRequest, partitionHash);
    ...
    public Future<byte[]> asyncGet(byte[] hashKey, byte[] sortKey, int timeout/*ms*/) {
        ...
        rrdb_get_operator op = new rrdb_get_operator(gpid, table.getTableName(), request, partitionHash);
        Table.ClientOPCallback callback = new Table.ClientOPCallback() {
            @Override
            public void onCompletion(client_operator clientOP) {
    ...
    private Future<MultiGetResult> asyncMultiGet(byte[] hashKey, List<byte[]> sortKeys,
        ...
        gpid gpid = table.getGpidByHash(partitionHash);
        rrdb_multi_get_operator op = new rrdb_multi_get_operator(gpid, table.getTableName(), request, partitionHash);
    ...
    public Future<Void> asyncMultiSet(byte[] hashKey, List<Pair<byte[], byte[]>> values,
        ...
        long partitionHash = table.getKeyHash(hashKey);
        gpid gpid = table.getGpidByHash(partitionHash);
        rrdb_multi_put_operator op = new rrdb_multi_put_operator(gpid, table.getTableName(), request, partitionHash);
    ...
    public Future<Void> asyncDel(byte[] hashKey, byte[] sortKey, int timeout) {
        ...
        long partitionHash = table.getHash(request.data);
        gpid gpid = table.getGpidByHash(partitionHash);
        rrdb_remove_operator op = new rrdb_remove_operator(gpid, table.getTableName(), request, partitionHash);
    ...
    public Future<Void> asyncMultiDel(byte[] hashKey, final List<byte[]> sortKeys, int timeout) {
        ...
        long partitionHash = table.getKeyHash(hashKey);
        gpid pid = table.getGpidByHash(partitionHash);
        rrdb_multi_remove_operator op = new rrdb_multi_remove_operator(pid, table.getTableName(), request, partitionHash);
    ...
    public Future<Long> asyncIncr(byte[] hashKey, byte[] sortKey, long increment, int ttlSeconds, int timeout) {
        ...
        gpid gpid = table.getGpidByHash(partitionHash);
        rrdb_incr_operator op = new rrdb_incr_operator(gpid, table.getTableName(), request, partitionHash);
    ...
    public Future<CheckAndSetResult> asyncCheckAndSet(byte[] hashKey, byte[] checkSortKey, CheckType checkType,
        ...
        long partitionHash = table.getKeyHash(hashKey);
        gpid gpid = table.getGpidByHash(partitionHash);
        rrdb_check_and_set_operator op = new rrdb_check_and_set_operator(gpid, table.getTableName(), request, partitionHash);
...

    {
        ...
        long partitionHash = table.getKeyHash(hashKey);
        gpid gpid = table.getGpidByHash(partitionHash);
        rrdb_check_and_mutate_operator op = new rrdb_check_and_mutate_operator(gpid, table.getTableName(), request, partitionHash);
